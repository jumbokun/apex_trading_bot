...
class VolatilityConfig:
    ...
    """
    # ATR% 阈值 (放宽区间减少敏感度)
    vol_low: float = 0.004   # 0.4% - 低波动阈值 (满仓)
    vol_high: float = 0.012  # 1.2% - 高波动阈值 (最低仓)
...
class AdaptiveHedgingConfig:
    ...
    max_notional: float = 60000.0   # 最大单边仓位 60,000U
    ...
    # 调仓参数
    rebalance_interval_seconds: int = 900   # 15分钟检查
    min_rebalance_interval_seconds: int = 900
